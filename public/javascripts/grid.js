...
var Gap = 20,
  mass = 100,
  o1 = 0.05,
  o2 = 0.1; // o1&2 offset weight
var bX = [o1, o2, o2, o2, o1],
  bY = [o1, o2, o2, o2, o1];
var color = "rgba(102,155,235,0.85)",
  width = 1.5,
  linesX = [],
  linesY = [];

function Line() {
  //just creates an svg line element, no attributes given.
...
var buildLines;
(buildLines = function() {
  var uX = window.innerWidth,
    uY = window.innerHeight;
